...
const STRINGS = {
  ja: {
    ...
    'search.filter.code': 'コードあり',
    'search.filter.concept': '用語のみ',
    'search.filter.fav': 'お気に入り',
    'search.filter.more': 'もっと絞り込む',
    'search.filter.reset': 'フィルタを全て解除',
    'search.filter.group.style': 'スタイル',
    'search.filter.group.tech': '技術',
    'search.filter.group.elem': '要素',
    'search.filter.group.genre': 'ジャンル',
    'search.filter.style.dark': 'ダーク',
    'search.filter.style.light': '明るい',
    'search.filter.style.gradient': 'グラデ',
    'search.filter.style.glass': 'グラス',
    'search.filter.style.anim': 'アニメ',
    'search.filter.tech.js': 'JS',
    'search.filter.tech.responsive': 'レスポンシブ',
    'search.filter.tech.svg': 'SVG',
    'search.filter.tech.hover': 'ホバー',
    'search.filter.tech.themed': 'ダーク対応',
    'search.filter.elem.form': 'フォーム',
    'search.filter.elem.button': 'ボタン',
    'search.filter.elem.card': 'カード',
    'search.filter.elem.nav': 'ナビ',
    'search.filter.elem.display': '見出し',
    'search.filter.genre.showcase': 'ショーケース',
    'search.filter.genre.ref': 'リファレンス',
    'search.filter.genre.app': 'アプリ',
    'search.filter.genre.corp': 'コーポ',
    'search.filter.genre.site': 'サイト骨格',
    'sidebar.terms': '用語',
    'header.menu': 'メニュー',
    'header.view': '表示切替',
  ...
  en: {
    ...
    'search.filter.code': 'With code',
    'search.filter.concept': 'Concepts only',
    'search.filter.fav': 'Favorites',
    'search.filter.more': 'More filters',
    'search.filter.reset': 'Clear all filters',
    'search.filter.group.style': 'Style',
    'search.filter.group.tech': 'Tech',
    'search.filter.group.elem': 'Element',
    'search.filter.group.genre': 'Genre',
    'search.filter.style.dark': 'Dark',
    'search.filter.style.light': 'Light',
    'search.filter.style.gradient': 'Gradient',
    'search.filter.style.glass': 'Glass',
    'search.filter.style.anim': 'Animated',
    'search.filter.tech.js': 'JS',
    'search.filter.tech.responsive': 'Responsive',
    'search.filter.tech.svg': 'SVG',
    'search.filter.tech.hover': 'Hover',
    'search.filter.tech.themed': 'Dark-aware',
    'search.filter.elem.form': 'Form',
    'search.filter.elem.button': 'Button',
    'search.filter.elem.card': 'Card',
    'search.filter.elem.nav': 'Nav',
    'search.filter.elem.display': 'Heading',
    'search.filter.genre.showcase': 'Showcase',
    'search.filter.genre.ref': 'Reference',
    'search.filter.genre.app': 'App',
    'search.filter.genre.corp': 'Corp',
    'search.filter.genre.site': 'Site skeleton',
    'sidebar.terms': 'terms',
    'header.menu': 'Menu',
